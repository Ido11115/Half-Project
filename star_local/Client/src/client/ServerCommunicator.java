...
/**
 * The ServerCommunicator class is responsible for handling communication between the client and the server.
 * It provides methods to send requests to the server and receive responses, as well as specialized operations
 * for managing subscriber and subscription data.
 */
public class ServerCommunicator {
    ...
    /**
     * Constructs a new ServerCommunicator and establishes a connection to the server.
     *
     ...
     * @throws IOException if an error occurs while retrieving the subscription history
     */
     ...
     * @throws IOException if an error occurs while retrieving the subscriber's status
     */
